...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        # return sum([(p1 - p2)**2 for p1, p2 in zip(self.points, other.points)]) ** 0.5
    ...
    def averageLinkageDist(self, other):
        ...
        # TO DO
        return sum([p1.distance(p2) for p1 in self.points for p2 in other.points])/len(self.points)/len(other.points)
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        # TO DO
        new_elem = Cluster(list(set(c1.points) | set(c2.points)), c1.pointType)
        self.members.append(new_elem)
    ...
    def findClosest(self, linkage):
        ...
        return min(((c1, c2) for c1, c2 in combinations(self.members, 2)), key=lambda a: linkage(a[0], a[1]))
