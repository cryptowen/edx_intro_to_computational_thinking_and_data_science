...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.cleaned_tiles.add((math.floor(pos.getX()), math.floor(pos.getY())))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        new_positon = self.position.getNewPosition(self.direction, self.speed)
        while not self.room.isPositionInRoom(new_positon):
            self.direction = random.random() * 360
            new_positon = self.position.getNewPosition(self.direction, self.speed)
        self.room.cleanTileAtPosition(new_positon)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    return 1.0 * sum(time_step_list) / len(time_step_list)
...
#       (... your call here ...)
#
# showPlot1('effect with different number of robots', 'number of robots', 'average time steps')
showPlot2('effect with different number of robots', 'number of robots', 'average time steps')
#
